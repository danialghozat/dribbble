      ...
      <section class="top">
        <div class="left">
          <div class="dribbbleLogo">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 24" role="img" aria-labelledby="6ul2gmuzdgdmwxtce95bqfgita2u0pr" class="icon dribbble-wordmark">
              <title id="6ul2gmuzdgdmwxtce95bqfgita2u0pr">Dribbble: the community for graphic design</title>
          ...
          <div class="dribbbleDetail">
            Dribbble is the world’s leading community for creatives to share, grow, and get hired.
          </div>
          <div class="socialsNetworkLogos">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="5xb0wr67dghaxw7xbbwnd8mcl8lm66f" role="img" viewBox="0 0 24 24" class="icon fill-current">
              <title id="5xb0wr67dghaxw7xbbwnd8mcl8lm66f">Twitter icon</title><path d="M23.954 4.569c-.885.389-1.83.654-2.825.775 1.014-.611 1.794-1.574 2.163-2.723-.951.555-2.005.959-3.127 1.184-.896-.959-2.173-1.559-3.591-1.559-2.717 0-4.92 2.203-4.92 4.917 0 .39.045.765.127 1.124C7.691 8.094 4.066 6.13 1.64 3.161c-.427.722-.666 1.561-.666 2.475 0 1.71.87 3.213 2.188 4.096-.807-.026-1.566-.248-2.228-.616v.061c0 2.385 1.693 4.374 3.946 4.827-.413.111-.849.171-1.296.171-.314 0-.615-.03-.916-.086.631 1.953 2.445 3.377 4.604 3.417-1.68 1.319-3.809 2.105-6.102 2.105-.39 0-.779-.023-1.17-.067 2.189 1.394 4.768 2.209 7.557 2.209 9.054 0 13.999-7.496 13.999-13.986 0-.209 0-.42-.015-.63.961-.689 1.8-1.56 2.46-2.548l-.047-.02z"></path>
            </svg>

            <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="o540xjff0ln3vz3vhnojbpjpu3qhjgv" role="img" viewBox="0 0 24 24" class="icon fill-current">
              <title id="o540xjff0ln3vz3vhnojbpjpu3qhjgv">Facebook icon</title><path d="M22.676 0H1.324C.593 0 0 .593 0 1.324v21.352C0 23.408.593 24 1.324 24h11.494v-9.294H9.689v-3.621h3.129V8.41c0-3.099 1.894-4.785 4.659-4.785 1.325 0 2.464.097 2.796.141v3.24h-1.921c-1.5 0-1.792.721-1.792 1.771v2.311h3.584l-.465 3.63H16.56V24h6.115c.733 0 1.325-.592 1.325-1.324V1.324C24 .593 23.408 0 22.676 0"></path>
            </svg>

            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414" role="img" class="icon fill-current">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="bytj3106tgs5omaf1dluo7mqpgfgrgi" role="img" viewBox="0 0 24 24" class="icon fill-current">
              <title id="bytj3106tgs5omaf1dluo7mqpgfgrgi">Pinterest icon</title><path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 5.079 3.158 9.417 7.618 11.162-.105-.949-.199-2.403.041-3.439.219-.937 1.406-5.957 1.406-5.957s-.359-.72-.359-1.781c0-1.663.967-2.911 2.168-2.911 1.024 0 1.518.769 1.518 1.688 0 1.029-.653 2.567-.992 3.992-.285 1.193.6 2.165 1.775 2.165 2.128 0 3.768-2.245 3.768-5.487 0-2.861-2.063-4.869-5.008-4.869-3.41 0-5.409 2.562-5.409 5.199 0 1.033.394 2.143.889 2.741.099.12.112.225.085.345-.09.375-.293 1.199-.334 1.363-.053.225-.172.271-.401.165-1.495-.69-2.433-2.878-2.433-4.646 0-3.776 2.748-7.252 7.92-7.252 4.158 0 7.392 2.967 7.392 6.923 0 4.135-2.607 7.462-6.233 7.462-1.214 0-2.354-.629-2.758-1.379l-.749 2.848c-.269 1.045-1.004 2.352-1.498 3.146 1.123.345 2.306.535 3.55.535 6.607 0 11.985-5.365 11.985-11.987C23.97 5.39 18.592.026 11.985.026L12.017 0z"></path>
            </svg>
        ...
        <div class="right">
          <div class="links">
              <div class="headerLink">For designer</div>
              <div class="link">Go Pro!</div>
              <div class="link">Explore design work</div>
              <div class="link">Design blog</div>
              <div class="link">Overtime podcast</div>
              <div class="link">Dribbble meetups</div>
              <div class="link">Playoffs</div>
              <div class="link">Code of conduct</div>
          </div>
          <div class="links">
            <div class="headerLink">Hire designer</div>
            <div class="link">Post a job opening</div>
            <div class="link">Post a freelance project</div>
            <div class="link">Search for designers</div>
            <div class="headerLink">Branding</div>
            <div class="link">Advertise with us</div>
          </div>
          <div class="links">
            <div class="headerLink">Company</div>
            <div class="link">About</div>
            <div class="link">Careers</div>
            <div class="link">Support</div>
            <div class="link">Media kit</div>
            <div class="link">Testimeonials</div>
            <div class="link">API</div>
            <div class="link">Terms of service</div>
            <div class="link">Privacy policy</div>
          </div>
          <div class="links">
            <div class="headerLink">Directories</div>
            <div class="link">Design jobs</div>
            <div class="link">Designer for hire</div>
            <div class="link">Freelance designers for <br> hire</div>
            <div class="link">Tags</div>
            <div class="link">Places</div>
            <div class="headerLink">Design assets</div>
            <div class="link">Shop Creative Market</div>
          </div>
        </div>
      </section>
      <section class="bottom">
        <div class="siteInfo">© 2021 Dribbble. All rights reserved.</div>
        <div class="dribbleShotCounter">
          <div class="shots"><span>1,505,782 </span>shots dribbbled</div>
          <div class="dribbleBallIcon"></div>
        </div>
      </section>
    </footer>
</template>
...
footer section.bottom div.siteInfo ,
footer section.bottom div.dribbleShotCounter {
...
footer section.bottom div.dribbleShotCounter div.shots {
  color: #6e6d7a;
  line-height: 1.5;
  height: 24px;
}

footer section.bottom div.dribbleShotCounter div.shots span {
  color: black;
  font-weight: bold;
}

footer section.bottom div.dribbleShotCounter div.dribbleBallIcon {
  width: 24px;
  height: 24px;
  background: #ea4c89;
  border-radius: 50%;
...
footer section.top div.left div.dribbbleLogo {
  width: 104px;
  height: 26px;
}

footer section.top div.left div.dribbbleLogo:hover svg {
  fill: #d24780;
  cursor: pointer;
}

footer section.top div.left div.dribbbleLogo svg {
 fill: #ea4c89;
}

footer section.top div.left div.dribbbleDetail {
  margin: 28px 0;
  color: #000;
  max-width: 100%;
  height: 60px;
...
footer section.top div.left div.socialsNetworkLogos {
  display: flex;
  width: 100%;
  height: 32px;
}
footer section.top div.left div.socialsNetworkLogos svg {
  width: 20px;
  height: 20px;
  fill: #000;
  margin-right: 16px;
...
footer section.top div.links {
  width: 160px;
  height: 360px;
  margin-left: 60px;
}

footer section.top div.links div.headerLink {
  display: block;
...
footer section.top div.links div.link {
  display: block;
  font-family: "Haas Grot Text R Web", "Helvetica Neue", Helvetica, Arial, sans-serif;
  font-size: 14px;
  font-weight: 400;
...
footer section.top div.links div.link:hover {
  cursor: pointer;
}
